...
- **[ADR-012](adr/012-canonical-web-and-api-urls.md)**: Use clean browser paths and a canonical `/api/v1` JSON boundary, with schema-hidden compatibility aliases for one release.
